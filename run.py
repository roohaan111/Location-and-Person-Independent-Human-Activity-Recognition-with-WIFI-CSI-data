...
#             # Concatenate sequence features along time dimension
...
#     parser.add_argument('--model', choices = ['MLP','LeNet','ResNet18','ResNet50','ResNet101','RNN','GRU','LSTM','BiLSTM', 'CNN+GRU','ViT', 'custom_model'])
